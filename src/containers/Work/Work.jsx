        ...
        <div className='p__work_section'>
          <div className='p__work_cards'>
              <Link to={`project/${projects[0].title}`}>
                <ProjectCard image={images.naruto} title='Naruto Website Design' alt='naruto' onClick={() => this.handleClick(0)}/>
              </Link>
              <Link to={`project/${projects[1].title}`}>
                <ProjectCard image={images.magicBrain} title="Image Detection App" alt='fda' onClick={() => this.handleClick(1)}/>
              </Link>
              <Link to={`project/${projects[2].title}`}>
                <ProjectCard image={images.gamborini} title="Gamborini Website Design" alt='gamborini' onClick={() => this.handleClick(2)}/>
              </Link>
